...
@main enum IdleProbe {
 @MainActor static func main() {
  ...
  for i in 0...16 {
    ...
    let view=RootView(model:model,service:NotchService(),consent:ConsentInbox(),onConsentAllow:{},onConsentDeny:{},onConsentDismiss:{},onAnswer:{_,_ in},panelSize:CGSize(width:320,height:460),restSize:CGSize(width:38,height:44))
