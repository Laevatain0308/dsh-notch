...
cp "$base/Sources/Protocol.swift" "$base/Sources/ProviderSession.swift" "$base/Sources/NotchCore.swift" "$base/Sources/Consent.swift" "$base/Sources/Endpoint.swift" "$base/Sources/Identity.swift" "$work/Sources/"
