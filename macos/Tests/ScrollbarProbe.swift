...
@main enum ScrollbarProbe {
  @MainActor static func main() {
    ...
    let host = NotchHostingView(rootView:RootView(model:model,service:NotchService(),consent:ConsentInbox(),onConsentAllow:{},onConsentDeny:{},onConsentDismiss:{},onAnswer:{_,_ in},panelSize:CGSize(width:480,height:800),restSize:CGSize(width:38,height:44)))
    host.sizingOptions = []
